...
var ObjectUtil = (function () {
    ...
    ObjectUtil.deepClone2 = function (obj) {
     ...
     * @param {Any} values
     */
    ObjectUtil.deepCloneCommon = function (values) {
        var copy;
    ...
    ObjectUtil.getValue = function (data, key, defVal) {
    ...
    ObjectUtil.hasValue = function (data, key) {
        if (!data) {
            return false;
        }
        key = key + "";
